              ...
              <div>
                ...
                {quantityOwned > 0 && (
                  <div className="mt-1 flex items-center">
                    ...
                    <span className="text-xs text-gray-300 font-medium">
                      Value: <span className="text-blue-300">₹{portfolioValue.toLocaleString(undefined, {maximumFractionDigits: 2})}</span>
                    </span>
                  </div>
                )}
              </div>
              ...
              {quantityOwned > 0 && (
                <div className="mt-3 p-2 bg-blue-500/10 rounded-md">
                  <div className="text-sm text-gray-300">
                    ...
                    Avg. cost: <span className="text-blue-300 font-medium">₹{(stock.avgCost || close).toFixed(2)}</span> •
                    P&L: <span className={`font-medium ${(close - (stock.avgCost || close)) >= 0 ? "text-green-400" : "text-red-400"}`}>
                      {((close - (stock.avgCost || close)) >= 0 ? "+" : "")}{((close - (stock.avgCost || close)) * quantityOwned).toFixed(2)} 
