...
function Pay() {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-black to-gray-900 flex justify-center p-4">
      ...
      <div className="mt-16 max-w-1xl overflow-hidden">
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" onClick={navigateToSIP}>
          SIP Calculator
        </button>
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full ml-10" onClick={navigateToCurrencyConverter}>
          Currency Converter
        </button>
      </div>

      <div className="mt-16 ml-50 h-130 max-w-3xl overflow-hidden">
        <WalletPreview />
      </div>
    </>
  );
