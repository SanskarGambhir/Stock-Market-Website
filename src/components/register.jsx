...
import { auth, provider, signInWithPopup, createUserWithEmailAndPassword, updateProfile } from "../firebase"
      ...
      <div className="relative w-full max-w-md p-8 overflow-hidden backdrop-blur-xl bg-black/30 border border-gray-800/50 rounded-2xl shadow-[0_0_40px_rgba(8,_112,_184,_0.2)]">
        ...
        <div className="relative z-10">
          ...
          <Button
            ...
            className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 font-medium mb-6"
            disabled={loading}
          >
            {loading ? (
          ...
          <div className="flex items-center my-6">
            ...
            <span className="mx-4 text-gray-400 text-sm font-medium">or register with</span>
            <div className="flex-grow h-px bg-gradient-to-r from-transparent via-gray-500/30 to-transparent"></div>
          </div>
